...
Rails gem to validate CPF. Don't forget to check {ValidatesCnpj}[https://github.com/plribeiro3000/validates_cnpj].
...
The gem has mactchers for shoulda-macros and remarkable.
